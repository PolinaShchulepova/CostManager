          ...
          addCost: function (entry) {
            return new Promise((resolve, reject) => {
              ...
              request.onerror = function (event) {
                reject(
                  new Error('Failed to add cost: ' + event.target.error.message)
                );
              };
            });
          },
          ...
          getAllCosts: function () {
            return new Promise((resolve, reject) => {
              ...
              request.onerror = function (event) {
                reject(
                  new Error(
                    'Failed to fetch costs: ' + event.target.error.message
                  )
                );
              };
            });
          ...
          updateCost: function (id, updatedEntry) {
            return new Promise((resolve, reject) => {
              ...
              request.onerror = function (event) {
                reject(
                  new Error(
                    'Failed to update cost: ' + event.target.error.message
                  )
                );
              };
            });
          ...
          deleteCost: function (id) {
            return new Promise((resolve, reject) => {
              ...
              request.onerror = function (event) {
                reject(
                  new Error(
                    'Failed to delete cost: ' + event.target.error.message
                  )
                );
              };
            });
