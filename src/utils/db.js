class Idb {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onupgradeneeded = (event) => {
                ...
                if (!db.objectStoreNames.contains("incomes")) {
                    const store = db.createObjectStore("incomes", { keyPath: "id", autoIncrement: true });
                    store.createIndex("category", "category", { unique: false });
                    store.createIndex("date", "date", { unique: false });
                }
            };
    ...
    async addCost(entry) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onerror = (event) => reject(new Error("Failed to add cost: " + event.target.error.message));
        });
    }
    ...
    async getAllCosts() {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onerror = (event) => reject(new Error("Failed to fetch costs: " + event.target.error.message));
        });
    }
    ...
    async updateCost(id, updatedEntry) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => resolve(true);
            request.onerror = (event) => reject(new Error("Failed to update cost: " + event.target.error.message));
        });
    }
    ...
    async deleteCost(id) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => resolve(true);
            request.onerror = (event) => reject(new Error("Failed to delete cost: " + event.target.error.message));
        });
    }
    ...
    async getAllIncomes() {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = (event) => resolve(event.target.result);
            request.onerror = (event) => reject(new Error("Failed to fetch incomes: " + event.target.error.message));
        });
    }
    ...
    async updateIncome(id, updatedIncome) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => resolve(true);
            request.onerror = (event) => reject(new Error("Failed to update income: " + event.target.error.message));
        });
    }
    ...
    async deleteIncome(id) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => resolve(true);
            request.onerror = (event) => reject(new Error("Failed to delete income: " + event.target.error.message));
        });
    }
}
